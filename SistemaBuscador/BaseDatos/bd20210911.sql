USE [cib4023600db]
GO
/****** Object:  Table [dbo].[usuarios]    Script Date: 11-09-2021 11:07:32 ******/
SET ANSI_NULLS ON
GO
...
GO
INSERT [dbo].[usuarios] ([id], [nombres], [apellidos], [nombreUsuario], [rolId], [password]) VALUES (5, N'Francisco', N'Nuñez', N'fnunez', 3, N'e0dec1dd4418cc0c23baf81812d8b70135ea4510c49159fc7f')
GO
SET IDENTITY_INSERT [dbo].[usuarios] OFF
GO
/****** Object:  StoredProcedure [dbo].[sp_actualiza_password]    Script Date: 11-09-2021 11:07:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where id = @id
GO
/****** Object:  StoredProcedure [dbo].[sp_actualiza_usuario]    Script Date: 11-09-2021 11:07:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where id = @id
GO
/****** Object:  StoredProcedure [dbo].[sp_check_nombre_usuario]    Script Date: 11-09-2021 11:07:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_check_usuario]    Script Date: 11-09-2021 11:07:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_eliminar_usuario]    Script Date: 11-09-2021 11:07:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where id=@id
GO
/****** Object:  StoredProcedure [dbo].[sp_insertar_usuario]    Script Date: 11-09-2021 11:07:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[sp_obtener_usuario_por_id]    Script Date: 11-09-2021 11:07:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
where id=@id
GO
/****** Object:  StoredProcedure [dbo].[sp_obtener_usuarios]    Script Date: 11-09-2021 11:07:32 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
